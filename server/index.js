...
// Import shpool session manager functions
import {
  getSessionName,
  shpoolSessionExists,
  listShpoolSessions,
...
} from './services/shpoolManager.js';
...
// Note: Shpool session functions (getSessionName, shpoolSessionExists, listShpoolSessions,
// createPtySession, createPtySessionForTab, buildAICommand) are now imported from
// ./services/shpoolManager.js

// Note: Project analyzer functions (getLastModifiedTime, calculateProjectCompletion,
// detectTechnologies) are now imported from ./services/projectAnalyzer.js
