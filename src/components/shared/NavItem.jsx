 ...
 * Used for navigation links in sidebars
 *
 * Matches the LeftSidebar ProjectItem pattern
 */

/**
 * NavItem Component
 * @param {string} label - Item label
 * @param {React.ReactNode} icon - Optional icon (SVG preferred)
 * @param {boolean} isActive - Whether this item is currently selected
 * @param {function} onClick - Click handler
 * @param {string|number} badge - Optional badge value
 * @param {string} badgeColor - Badge color style
...
export default function NavItem({
  ...
  return (
    ...
    >
      {/* Icon */}
      {icon && (
        <span className={`w-4 h-4 flex-shrink-0 ${isActive ? '' : 'opacity-60'}`}>
          {icon}
        </span>
      )}
...
export const NavIcons = {
  ...
  robot: (
    <svg fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 15.3M14.25 3.104c.251.023.501.05.75.082M19.8 15.3l-1.57.393A9.065 9.065 0 0112 15a9.065 9.065 0 00-6.23.693L5 14.5m14.8.8l1.402 1.402c1.232 1.232.65 3.318-1.067 3.611l-.772.129a9 9 0 01-2.363.095c-.26-.03-.52-.067-.78-.112a5.3 5.3 0 00-4.44 0c-.26.045-.52.082-.78.112a9 9 0 01-2.363-.095l-.772-.129c-1.717-.293-2.299-2.379-1.067-3.611L5 14.5" />
    </svg>
  ),
  server: (
    <svg fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
