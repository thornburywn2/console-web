        ...
        {activeCategory === CATEGORIES.SCANS && (
          <div className="space-y-6">
            ...
            {scanRecommendations && scanRecommendations.systemSpecs && (
              <div className="p-4 rounded bg-hacker-dark/50 border border-hacker-cyan/30 space-y-3">
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded border-hacker-warning/50 bg-transparent text-hacker-warning focus:ring-hacker-warning/50"
                    />
